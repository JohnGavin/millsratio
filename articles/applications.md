...
# Load precomputed data from targets pipeline
...
t30_paradox <- readRDS(system.file("extdata", "t30_paradox_analysis.rds", package = "millsratio"))
```
...
![](applications_files/figure-html/truncated-regression-1.png)
...
![](applications_files/figure-html/survival-analysis-1.png)
...
![](applications_files/figure-html/outlier-detection-1.png)
